		...
		$(document).ready(function(){
		  ...
		  function afficheGrid(x) {
              if (x.matches) { // If media query matches
                ...
                $('.postContainer .list-group-item').removeClass('d-block').addClass('d-none');
                $('.postContainer .grid-group-item').removeClass('d-none').addClass('d-block');
              } else {
                if (document.getElementById('list')) document.getElementById('list').style.display = 'block';
